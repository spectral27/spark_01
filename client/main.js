...
function selectAllItems() {
    ...
    xhttp.open("GET", "http://localhost:4567/items");
...
function insertItem() {
    ...
    var xhttp = new XMLHttpRequest();
    xhttp.open('POST', 'http://localhost:4567/items');
...
function updateItem() {
    ...
    var xhttp = new XMLHttpRequest();
    xhttp.open('PUT', 'http://localhost:4567/items/' + id);
    xhttp.setRequestHeader('Content-Type', 'application/json');
    xhttp.onload = function() {
        document.getElementById("mainTable").innerHTML = "";
        selectAllItems();
...
function deleteItem() {
    ...
    var xhttp = new XMLHttpRequest();
    xhttp.open('DELETE', 'http://localhost:4567/items/' + id);
    xhttp.onload = function() {
        document.getElementById("mainTable").innerHTML = "";
        selectAllItems();
    }
